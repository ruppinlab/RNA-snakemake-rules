...
# files
GDC_GENOME_FASTA_TARGZ_FILE = join("GRCh38.d1.vd1.fa.tar.gz")
GDC_GENOME_FASTA_FILE = join("GRCh38.d1.vd1.fa")
GDC_GTF_FILE = join("gencode.v22.annotation.gtf")
GENCODE_TRANSCRIPT_FASTA_FILE = join("gencode.v32.transcripts.fa.gz")
GENCODE_GENOME_FASTA_FILE = join("GRCh38.p13.genome.fa")
GENCODE_GTF_FILE = join("gencode.v32.annotation.gtf")
